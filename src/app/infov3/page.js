    ...
    <main className="flex flex-col items-center justify-start min-h-screen p-6 bg-[#ff6508] text-white">
      ...
      {/* Preview */}
        ...
        >
            ...
            <div className="absolute bottom-0 left-0 w-full px-15 text-white flex flex-col items-center mb-65 top-230">
                <p
                    className="text-center font-bold"
                    style={{ fontSize: "100px", lineHeight: "0.9" }}
                >
                  <span className="text-[#77ff08]">{quote}</span> {quote2}
                </p>

              <div className="absolute justify-center items-center left-120 top-80 mt-5" style={{ fontSize: "22px"}}>
              <p>centrafootball</p>
              </div>
            </div>
        </div>
