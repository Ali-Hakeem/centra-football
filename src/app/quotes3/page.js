  ...
  return (
    <main className="flex flex-col items-center justify-start min-h-screen p-6 bg-[#ff6508] text-white">
      ...
      {/* Preview */}
        ...
        <div className="absolute bottom-0 left-0 w-full px-15 text-white flex flex-col items-center mb-65 top-175">
               <p
               className="text-center font-bold text-[#77ff08]"
               style={{ fontSize: "140px", lineHeight: "0.9", rotate: 90 }}
               >❛❛ </p>
                <p
                    className="text-center font-bold"
                    style={{ fontSize: "90px", lineHeight: "0.9" }}
                >
                  <span className="text-[#77ff08]">{quote}</span><br></br> {quote2}
                </p>
              {author && (
                <p
